...
//以上导入方式报错信息是（Component series.line not exists. Load it first.）
//所以使用以下导入方式
...
class KECharts extends Component {
    componentDidMount() {
    ...
    render() {
        return (
            <div id="kecharts" style={{ width: 1000, height: 400 }}></div>
        )
    }
}
export default KECharts;